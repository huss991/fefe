    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="relative w-full max-w-2xl bg-white dark:bg-[#0B1F3F] rounded-xl shadow-xl overflow-hidden">
              <button
                onClick={onClose}
              ...
              <div className="p-8">
                <h2 className="text-2xl font-bold text-[#0B1F3F] dark:text-white mb-2">
                  {t('contact-title')}
                </h2>
